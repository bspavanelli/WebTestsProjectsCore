package br.com.bspavanelli.web.utilities.listener;
...
import br.com.bspavanelli.web.utilities.DriverFactory;
...
public class TestListener extends TestWatcher {
	...
	public byte[] takeScreenshot(String methodName) {
		...
		try {
			FileUtils.copyFile(imagem, new File("target/screenshots/ " + BaseConstants.webBrowser.getValor() + "/" + methodName + ".png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
